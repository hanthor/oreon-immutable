...
- **Bootc Container Validation**: `podman run --rm ghcr.io/hanthor/oreon-bootc:latest bootc container lint` ✓ WORKS
...
3. **Test pre-built image**: `podman pull ghcr.io/hanthor/oreon-bootc:latest` ✓ WORKS
4. **Test bootc functionality**: `podman run --rm ghcr.io/hanthor/oreon-bootc:latest bootc container lint` ✓ WORKS
...
```
/home/runner/work/oreon-bootc/oreon-bootc/
...
- **Pre-built Alternative**: Repository already has pre-built image at `ghcr.io/hanthor/oreon-bootc:latest` ✓ WORKS
...
2. **Pre-built image testing**: `podman pull ghcr.io/hanthor/oreon-bootc:latest` ✓ WORKS (pulls successfully)
3. **Bootc validation**: `podman run --rm ghcr.io/hanthor/oreon-bootc:latest bootc container lint` ✓ WORKS
